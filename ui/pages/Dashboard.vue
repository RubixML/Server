    ...
    <div>
        ...
        <section class="section">
            <div class="container">
                <div class="columns">
                    <div class="column is-half">
                        <h2 class="title is-size-5"><span class="icon mr-3"><i class="fas fa-cog"></i></span>Settings</h2>
        ...
        <section class="section">
            <div class="container">
                <div class="columns">
                    <div class="column is-half">
                        <h2 class="title is-size-5"><span class="icon mr-3"><i class="fas fa-microchip"></i></span>Process Info</h2>
